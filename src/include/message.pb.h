...
PROTOBUF_NAMESPACE_OPEN
template<> ::MyRPCnamespace::RpcHeader* Arena::CreateMaybeMessage<::MyRPCnamespace::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MyRPCnamespace {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MyRPCnamespace.RpcHeader) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MyRPCnamespace.RpcHeader";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:MyRPCnamespace.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:MyRPCnamespace.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 service_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MyRPCnamespace.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:MyRPCnamespace.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:MyRPCnamespace.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MyRPCnamespace.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:MyRPCnamespace.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 method_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MyRPCnamespace.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:MyRPCnamespace.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:MyRPCnamespace.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  method_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_name,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:MyRPCnamespace.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:MyRPCnamespace.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:MyRPCnamespace.RpcHeader.args_size)
}
